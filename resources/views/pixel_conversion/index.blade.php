                            ...
                            <table id="demo-foo-row-toggler" class="table toggle-circle table-hover">
                                ...
                                <tbody>
                                    ...
                                    @foreach($pixeis as $pixel)
                                        <tr class="gradeU">
                                            <td><a href="links_campanha.html">{{ $pixel->name }}</a></td>
                                            <td>3.200</td>
                                            <td>R$ 4.000</td>
                                            <td>18/12/2016</td>
                                            <td>{{ $pixel->time_interval . ' ' . $pixel->interval_type }}</td>
                                            <td class="actions">
                                                <a href="#" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                                                <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                                <a href="#" class="on-default edit-row code_tags_js" data-toggle="modal" data-target="#myModal" data-id-user-code="{{ session('id') }}" data-id-code="{{ $pixel->id }}"><i class="typcn typcn-code"></i></a>
